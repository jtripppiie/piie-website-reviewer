...
test('URL previews remain viewport-height scroll containers', () => {
  ...
  assert.match(layout, /desktop: \{ label: 'Full desktop', w: 1440, h: 1600/);
  assert.match(layout, /'laptop-13': \{ label: '13 display', w: 1180, h: 1600/);
  assert.match(layout, /mobile: \{ label: 'Mobile', w: 390, h: 1600/);
